...
GameWidget::GameWidget(int level, QWidget *parent) {
    ...
    timer->start(300);
    //背景音乐
    //playMusic("backgroundMusic.mp3", true);
}
/**
 ...
 */
void GameWidget::moveBtn(MyButton *btn, QPoint start, QPoint end, int duration){
