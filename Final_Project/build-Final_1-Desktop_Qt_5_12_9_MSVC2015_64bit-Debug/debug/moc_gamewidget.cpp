...
#include "../../Final_1/GameLevel1/gamewidget.h"
...
QT_MOC_LITERAL(1, 11, 10), // "backToMain"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10) // "eraseBoxes"

    },
    "GameWidget\0backToMain\0\0eraseBoxes"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::backToMain)) {
                *result = 0;
                return;
            }
        }
