...
"background-image:url(\"E://uiProject//paused.png\");"));
        ...
        backBtn->setGeometry(QRect(30, 260, 401, 101));
        backBtn->setStyleSheet(QString::fromUtf8(""));
        pauseBackground = new QLabel(PauseWidget);
        pauseBackground->setObjectName(QString::fromUtf8("pauseBackground"));
        pauseBackground->setGeometry(QRect(-20, -90, 561, 531));
        pauseBackground->setStyleSheet(QString::fromUtf8("background-image: url(:/uiProject/pauseBackground1.png);"));
        slowSpeedbtn->raise();
        speedLabel->raise();
        curSpeedLabel->raise();
        pausedLabel->raise();
    ...
    void retranslateUi(QWidget *PauseWidget)
    {
        ...
        pauseBackground->setText(QString());
    } // retranslateUi
