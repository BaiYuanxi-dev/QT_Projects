...
Widget::Widget(QWidget *parent): QWidget(parent), ui(new Ui::Widget){
    ...
    //设置背景
    QPalette palette;
    QPixmap pixmap("D:/Qt/Final_Project2/Game1/uiProject/gameBackground.png");
    ...
    ui->pauseBtn->setIcon(QIcon(QString("D:/Qt/Final_Project2/Game1/uiProject/pauseBtn.png")));
...
void Widget::slotWhich2Change(MyButton * btn){
    QtConcurrent::run([=](){
        ...
        myPlayer->setMedia(QUrl::fromLocalFile("D:/Qt/Final_Project2/Game1/uiProject/mp3/click.mp3"));
