...
Widget::Widget(QWidget *parent): QWidget(parent), ui(new Ui::Widget){
    ...
    //设置背景
    QPalette palette;
    QPixmap pixmap("D:/Qt/Final_Project2/Game4/uiProject/gameBackground.png");
    ...
    for(int i = 0; i < 8; i++){
        for(int j = 0; j < 8; j++){
            ...
            this->buttons[i][j] = new MyButton4(this, j, i, rand() % 5);
    ...
    ui->pauseBtn->setIcon(QIcon(QString("D:/Qt/Final_Project2/Game4/uiProject/pauseBtn.png")));
...
void Widget::slotWhich2Change(MyButton * btn){
    QtConcurrent::run([=](){
        ...
        myPlayer->setMedia(QUrl::fromLocalFile("D:/Qt/Final_Project2/Game4/uiProject/mp3/click.mp3"));
...
void Widget::playMusic(QString s){
    QtConcurrent::run([=](){
        QMediaPlayer *myPlayer= new QMediaPlayer;
        myPlayer->setMedia(QUrl::fromLocalFile("D:/Qt/Final_Project2/Game4/uiProject/mp3/" + s));
