...
endGame::endGame(QWidget *parent) :QWidget(parent),ui(new Ui::endGame){
    ...
    ui->pushButton->setIcon(QIcon(QString("D:/Qt/Final_Project2/Game4/uiProject/continue.png")));
...
void endGame::on_pushButton_clicked(){
    ...
    newStar1->setStyleSheet("border-image:url(\"D:/Qt/Final_Project2/Game4/uiProject/fullStar.png\");");
    newStar2->setStyleSheet("border-image:url(\"D:/Qt/Final_Project2/Game4/uiProject/fullStar.png\");");
    newStar3->setStyleSheet("border-image:url(\"D:/Qt/Final_Project2/Game4/uiProject/fullStar.png\");");
