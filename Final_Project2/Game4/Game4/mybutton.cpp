...
MyButton::MyButton(QWidget *parent, int x, int y, int icon):QPushButton(parent){
    ...
    this->isErased = 0;
    this->icon = icon;
    this->setIcon(QIcon(QString("D:/Qt/Final_Project2/Game4/uiProject/box%1.png").arg(this->icon)));
...
void MyButton::reset(int flag){
    if(flag == 0){
        ...
        this->icon = rand() % 5;
        this->setIcon(QIcon(QString("D:/Qt/Final_Project2/Game4/uiProject/circle%1.png").arg(this->icon)));
