...
//    }
    ...
    struct ArcCell *p;
    p = nodes[nVex]->firstArc;

//    if( nIndex != numOfNodes){
//        p = nodes[nVex]->firstArc;
//        while( p != nullptr && visited[p->index] == true){
//            p = p->next;
//        }
...
//        for (int i = 0; i < numOfNodes; i++)
//        {
//            if (matrix[nVex][i] != 0 && visited[i] == 0)
//            {
//                DFSAlgo(i, nIndex, aPath);//递归遍历
//                visited[i] = false;
//                nIndex--;
//            }
//        }
        ...
        //如果未被访问且连通
        while( p!= nullptr && visited[p->index] == false){
//            if(aPath[1] == 5 && aPath[2] == 4 && aPath[3] == 3){
//                cout << "xxx p->index" << p->index <<endl;
//            }
            DFSAlgo(p->index, nIndex, aPath);
//            if( aPath[1] == 5 ){
//                cout << endl;
//                cout << "!!!!!!!!!!!!!!!!!" <<endl;
//                if( aPath[2] == 4 && aPath[3] == 3){
//                    cout << "0543" << endl;
...
//            if(aPath[0] == 0 && aPath[1] == 5 && aPath[2] == 4 && aPath[3] == 3){
////                //cout << "nVex = " << nVex << endl;
//                cout << "wsnm p->index = " << p->index << endl;
//                if( p->next != nullptr){
//                    cout << "p->next != nullptr" <<endl;
//                } else {
//                    cout << "p->next  ===== nullptr" <<endl;
//                }
//                struct ArcCell * q = p;
...
//G：图的邻接表， nVex访问的顶点， nIndex，aPath数组下标， aPath[]一条路径， pathList，所有的路径的链表
//void DFSTraverse(int G[20][20],int nVex,int &nIndex,int aPath[],Path* Pathlist) {
//    visited[nVex] = true;
//    aPath[nIndex++] = nVex;
...
//        for (int i = 0; i < CGraph::m_nVexNum; i++)
//        {
//            if (CGraph::m_aAdjMatrix[nVex][i] != 10000 && visited[i] == 0)
//            {
//                CGraph::DFSTraverse(G, i, nIndex, aPath, Pathlist);//递归遍历
//                visited[i] = false;
//                nIndex--;
//            }
//        }
