    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->queueNumLine->setReadOnly(true);
    ui->queueNumLine->setText(QString::number(partingLot->getQueueLength()));
    ...
    connect(ui->addQueueButton, &QPushButton::clicked, [=](){
        if ( ui->idLine->text().toStdString() == "" ) {
            QMessageBox::information(this, "warning", "请输入车牌号");
            return;
        }
...
void MainWindow::setStyles(){
    ...
    ui->queueNumLine->setPalette(palette);
